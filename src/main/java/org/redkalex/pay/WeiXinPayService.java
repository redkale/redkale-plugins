...
public final class WeiXinPayService extends AbstractPayService {
    ...
    public CompletableFuture<PayPreResponse> prepayAsync(PayPreRequest request) {
        ...
        try {
            ...
            return postHttpContentAsync(element.client, "https://api.mch.weixin.qq.com/pay/unifiedorder", formatMapToXML(map)).thenApply(responseText -> {
    ...
    public CompletableFuture<PayQueryResponse> queryAsync(PayRequest request) {
        ...
        try {
            ...
            map.put("nonce_str", Long.toHexString(System.currentTimeMillis()) + Long.toHexString(System.nanoTime()));
            map.put("sign", createSign(element, map, null));
            return postHttpContentAsync(element.client, "https://api.mch.weixin.qq.com/pay/orderquery", formatMapToXML(map)).thenApply(responseText -> {
                result.setResponsetext(responseText);
    ...
    public CompletableFuture<PayResponse> closeAsync(PayCloseRequest request) {
        ...
        try {
            ...
            map.put("out_trade_no", request.getPayno());
            map.put("sign", createSign(element, map, null));
            return postHttpContentAsync(element.client, "https://api.mch.weixin.qq.com/pay/closeorder", formatMapToXML(map)).thenApply(responseText -> {
                result.setResponsetext(responseText);
    ...
    public CompletableFuture<PayRefundResponse> refundAsync(PayRefundRequest request) {
        ...
        try {
            ...
            map.put("sign", createSign(element, map, null));
            return Utility.remoteHttpContentAsync(element.client, "POST", "https://api.mch.weixin.qq.com/secapi/pay/refund", 10_000, null, formatMapToXML(map)).thenApply(out -> {
                String responseText = out.toString(StandardCharsets.UTF_8);
                result.setResponsetext(responseText);
    ...
    public CompletableFuture<PayRefundResponse> queryRefundAsync(PayRequest request) {
        ...
        try {
            ...
            map.put("nonce_str", Long.toHexString(System.currentTimeMillis()) + Long.toHexString(System.nanoTime()));
            map.put("sign", createSign(element, map, null));
            return postHttpContentAsync(element.client, "https://api.mch.weixin.qq.com/pay/refundquery", formatMapToXML(map)).thenApply(responseText -> {
                result.setResponsetext(responseText);
    ...
    public static class WeixinPayElement extends PayElement {
        ...
        public void setPaySSLContext(InputStream in) throws Exception {
            ...
            this.client = HttpClient.newBuilder().sslContext(ctx).build();
        }
