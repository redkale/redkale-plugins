...
public class SimpleBean {
    ...
    public void run1() throws Exception {
        ...
        System.out.println(
                ProtobufConvert.root().convertFrom(SimpleBean.class, bs).toString());
        System.out.println(
                JsonConvert.root().convertFrom(SimpleBean.class, jsonbs).toString());
    }

    private static PSimpleBeanOuterClass.PSimpleBean createPSimpleBean(
            SimpleBean bean, PSimpleBeanOuterClass.PSimpleBean.Builder builder) {
        if (builder == null) {
