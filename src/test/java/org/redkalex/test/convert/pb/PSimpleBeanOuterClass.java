...
public final class PSimpleBeanOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      PSimpleBeanOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        PSimpleBean.class.getName());
    }
    // Use PSimpleBean.newBuilder() to construct.
    private PSimpleBean(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    private PSimpleBean() {
      strings_ = "";
    ...
    private static final long serialVersionUID = 0L;
      static {
        com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
          ...
          /* patch= */ 2,
          /* suffix= */ "",
          PSimpleEntry.class.getName());
      }
      // Use PSimpleEntry.newBuilder() to construct.
      private PSimpleEntry(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
    ...
    private static final long serialVersionUID = 0L;
      static {
        com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
          ...
          /* patch= */ 2,
          /* suffix= */ "",
          PTwoEntry.class.getName());
      }
      // Use PTwoEntry.newBuilder() to construct.
      private PTwoEntry(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
      private PTwoEntry() {
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(strings_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, strings_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(strings_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, strings_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
