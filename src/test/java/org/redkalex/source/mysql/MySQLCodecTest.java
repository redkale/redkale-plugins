    ...
    public void run() throws Exception {
        ...
        new WorkThread("", 0, 1, null, null) {
            public void run() {
                ...
                info.username = "root";
                info.password = "";
                MyClient client = new MyClient("test", null, "rw", new ClientAddress(new InetSocketAddress("127.0.0.1", 3389)), Utility.cpus(), 16, new Properties(), info, false, new Properties());
                MyClientConnection conn = (MyClientConnection) client.createClientConnection(1, asyncGroup.newTCPClientConnection());
                ...
                boolean bool;
                {
                    ...
                    bool = codec.decodeMessages(conn, realbuf, array);
